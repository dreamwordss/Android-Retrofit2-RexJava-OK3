...
/**
 * Created by libilang on 2018/3/26.
 */

public class LiveStremingCell implements View.OnClickListener {

    private LiveStremingActivity activity;
    ...
    public LiveStremingCell(LiveStremingActivity liveActivity , StreamLiveCameraView liveCameraView , String rtmpUrl) {
